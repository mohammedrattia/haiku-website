...
<ul>
	<li><strong>Version:</strong> R1/beta6</li>
	<li><strong>Release date:</strong> August 26, 2026</li>
	<li><strong><a href="/get-haiku/r1beta6/release-notes/">Release notes</a></strong></li>
...
<tbody>
    <tr class="link">
      ...
      <td><a class="track" href="https://mirrors.rit.edu/haiku/r1beta6/haiku-r1beta6-x86_gcc2h-anyboot.iso">iso</a></td>
      <td><a class="track" href="https://mirrors.rit.edu/haiku/r1beta6/haiku-r1beta6-x86_64-anyboot.iso">iso</a></td>
    </tr>
    <tr class="link">
      ...
      <td><a class="track" href="https://ftp.osuosl.org/pub/haiku/r1beta6/haiku-r1beta6-x86_gcc2h-anyboot.iso">iso</a></td>
      <td><a class="track" href="https://ftp.osuosl.org/pub/haiku/r1beta6/haiku-r1beta6-x86_64-anyboot.iso">iso</a></td>
    </tr>
	<tr class="link">
      <td class="location"><b>Location:</b> Falkenstein, Germany <br/>Provided by: <a target="_blank" class="ext" href="https://diyarciftci.xyz/" title="diyarciftci">Diyar Ciftci</a></td>
    ...
    <tr class="link">
      ...
      <td><a class="track" href="https://mirror.aarnet.edu.au/pub/haiku/r1beta6/haiku-r1beta6-x86_64-anyboot.iso">iso</a></td>
    </tr>
<!--
    <tr class="link">
      ...
      <td><a class="track" href="https://mirror.truenetwork.ru/haiku/haiku/r1beta6/haiku-r1beta6-x86_gcc2h-anyboot.iso">iso</a></td>
      <td><a class="track" href="https://mirror.truenetwork.ru/haiku/haiku/r1beta6/haiku-r1beta6-x86_64-anyboot.iso">iso</a></td>
    </tr>
-->
</tbody>
</table>
...
<ul>
 <li><a class="track" href="https://haiku-release.cdn.haiku-os.org/r1beta6/haiku-r1beta6-x86_gcc2h.torrent">haiku-r1beta6-x86_gcc2h.torrent</a></li>
 <li><a class="track" href="https://haiku-release.cdn.haiku-os.org/r1beta6/haiku-r1beta6-x86_64.torrent">haiku-r1beta6-x86_64.torrent</a></li>
</ul>
...
<pre>
bb7743474fd175aea511be1799764ba054465285bbdf54c4722ca61d1fb4f5c9  haiku-r1beta6-x86_64-anyboot.iso
5a55ad9429f1de9fb5ca5cbcd54de3733ff247cc7919ce5d690fb1271cb1dc76  haiku-r1beta6-x86_gcc2h-anyboot.iso
</pre>
...
<ul>
  <li><a class="track" href="https://haiku-release.cdn.haiku-os.org/r1beta6/haiku-r1beta6-x86_gcc2h-anyboot.iso.minisig">x86_gcc2h-anyboot minisig</a></li>
  <li><a class="track" href="https://haiku-release.cdn.haiku-os.org/r1beta6/haiku-r1beta6-x86_64-anyboot.iso.minisig">x86_64-anyboot minisig</a></li>
</ul>
...
haiku-r1beta6-x86_64-anyboot.iso.minisig

$ minisign -Vm haiku-r1beta6-x86_64-anyboot.iso -P RWTPfbfFRi5b+T02aw733p5dp/UI/1Z946YWBInmkPmBlx2Zy1Vyw9kP
Signature and comment signature verified
Trusted comment: timestamp:1787691534   file:haiku-r1beta6-x86_64-anyboot.iso   hashed
```
...
## Upgrading from R1/beta5

{{< alert-warning "Warning: only upgrading from Beta 5 is supported!" "It may be possible to upgrade from prior development images, but this is untested and you may run into unknown problems." >}}

There is an upgrade path available for users that are currently using Haiku R1/beta5. If you want to do this upgrade, you will have to use the Terminal to issue some commands.

The following commands will replace your existing "Haiku" and "HaikuPorts" repositories with their R1/beta6 equivalents:

```shell script
pkgman add-repo https://eu.hpkg.haiku-os.org/haiku/r1beta6/$(getarch)/current
pkgman add-repo https://eu.hpkg.haiku-os.org/haikuports/r1beta6/$(getarch)/current
```
...
If you are interested in mirroring our releases, Nightly builds or HaikuDepot packages, please don't hesitate to drop us a line on the <a href="https://discuss.haiku-os.org">forums</a>, <a href="https://www.haiku-os.org/community/irc">IRC</a>, or through our <a href="https://www.freelists.org/list/haiku">mailing list.</a>
